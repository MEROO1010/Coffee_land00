  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        ...
        children: [
          OnboardingPage(imagePath: 'assets/images/onboarding1.png'),
          OnboardingPage(imagePath: 'assets/images/onboarding2.png'),
          OnboardingPage(imagePath: 'assets/images/onboarding3.png'),
          OnboardingPage(
